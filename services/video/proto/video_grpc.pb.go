...
type VideoServiceClient interface {
	...
	DeleteVideo(ctx context.Context, in *DeleteVideoRequest, opts ...grpc.CallOption) (*common.Response, error)
	IncrementViewCount(ctx context.Context, in *IncrementViewCountRequest, opts ...grpc.CallOption) (*common.Response, error)
}
...
func (c *videoServiceClient) ListVideos(ctx context.Context, in *ListVideosRequest, opts ...grpc.CallOption) (*ListVideosResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/video.VideoService/ListVideos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoServiceClient) DeleteVideo(ctx context.Context, in *DeleteVideoRequest, opts ...grpc.CallOption) (*common.Response, error) {
...
func (c *videoServiceClient) IncrementViewCount(ctx context.Context, in *IncrementViewCountRequest, opts ...grpc.CallOption) (*common.Response, error) {
	out := new(common.Response)
	err := c.cc.Invoke(ctx, "/video.VideoService/IncrementViewCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VideoServiceServer interface {
	...
	DeleteVideo(context.Context, *DeleteVideoRequest) (*common.Response, error)
	IncrementViewCount(context.Context, *IncrementViewCountRequest) (*common.Response, error)
...
func (UnimplementedVideoServiceServer) DeleteVideo(context.Context, *DeleteVideoRequest) (*common.Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVideo not implemented")
}
func (UnimplementedVideoServiceServer) IncrementViewCount(context.Context, *IncrementViewCountRequest) (*common.Response, error) {
...
func _VideoService_ListVideos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.VideoService/ListVideos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VideoService_UpdateVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.VideoService/UpdateVideo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VideoService_IncrementViewCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.VideoService/IncrementViewCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var VideoService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/video/proto/video.proto",
}
